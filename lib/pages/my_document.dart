...
class DocumentSayaContent extends StatefulWidget {
  const DocumentSayaContent({super.key});

  @override
  _DocumentSayaContentState createState() => _DocumentSayaContentState();
}

class _DocumentSayaContentState extends State<DocumentSayaContent> {
                        ...
                        children: [
                          TableRow(
                            ...
                            children: const [
                              ...
                              _HeaderCell(text: "Uploader"),
                              _HeaderCell(text: "Created At"),
